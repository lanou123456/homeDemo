...
public class Email {
        ...
        private String sendAddr = "2582882610@qq.com";//这是发送方的邮箱
        private String receiveAddr ;//接收方的邮箱

        //这个不是密码,是开启163邮箱第三方登录时候设置的授权码
        //如果不开启,那么是无法第三方登录163邮箱账号的
        private String pass = "yaiihsexdegodiif";
        ...
        public void t1( String email,String uuid) throws MessagingException, GeneralSecurityException {
            ...
            msg.setContent("点击完成激活<br/><a href=http://192.168.1.103:8080/user?method=active&code="+uuid+">激活网址</a>", "text/html;charset=utf-8");
